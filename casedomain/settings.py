"""
Django settings for casedomain project.
...
ROOT_URLCONF = 'casedomain.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'casedomain')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'casedomain.wsgi.application'
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'someemail@server.org'
EMAIL_USER = 'someemail@server.org'
EMAIL_HOST_PASSWORD = 'email_password'

DEFAULT_FROM_EMAIL = 'someemail@server.org'
EMAIL_SENDER_FROM_ADDRESS = 'someemail@server.org'
...
REST_FRAMEWORK = {
    'EXCEPTION_HANDLER': 'casedomain.views.custom_exception_handler',
    ...
    'DEFAULT_RENDERER_CLASSES': [
        ...
        'casedomain.renderers.OnlyRawBrowsableAPIRenderer',
